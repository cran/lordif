save.plotDIF <-
function(obj,labels=c("Reference","Focal"),cexp=0.8,lwd=1.0,path="",save.prefix="",width=600,height=600) {
sumpp<-function(pp) {
...
if (path!="") jpeg(filename=paste(path,save.prefix,"%03d.jpg",sep=""),bg="white",quality=100,width=width,height=height)
