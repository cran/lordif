`lordif` <-
function(resp.data,group,selection=NULL,criterion="Chisqr",pseudo.R2="McFadden",alpha=0.01,beta.change=0.1,R2.change=0.035,
...
while (!compare(flags,flag.matrix) & iter < maxIter) {
iter<-iter+1
